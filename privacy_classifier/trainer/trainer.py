from data_module import PrivacyClassifierDataModule
from network_module import PrivacyClassifierNetworkModule
from model import PrivacyClassifierModel
...
def train(config, train_config):
    ...
    data_module = PrivacyClassifierDataModule(
        data_path=data_path,
        file_type=file_type,
