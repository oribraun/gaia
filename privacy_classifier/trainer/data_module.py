...
from trainer.custom_dataset import PrivacyClassifierCustomDataset


class PrivacyClassifierDataModule(ZIDSDataModule):
    """! Template for a Data Module, this is where we return the correct dataloader for every dataset:
    ...
    def __init__(self, data_path: str = '',
                 ...
                 seed=42,
                 num_workers=1,
                 dataset: Union[Dataset, PrivacyClassifierCustomDataset] = None,
                 test_set: Union[Dataset, PrivacyClassifierCustomDataset] = None,
    ...
    def prepare_data(self):
        ...
        if self.data_path != '':
            ...
            self.train_valid_set = PrivacyClassifierCustomDataset(ds_x, ds_y)
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if stage in (None, "fit") and self.train_valid_set is not None:
