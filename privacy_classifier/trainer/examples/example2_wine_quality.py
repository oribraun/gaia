from trainer.data_module import PrivacyClassifierDataModule
from trainer.network_module import PrivacyClassifierNetworkModule
from trainer.model import PrivacyClassifierModel
...
def train(config, train_config):
    ...
    wine_data_module = PrivacyClassifierDataModule(
        data_path=data_path,
...
if __name__ == '__main__':
    ...
    general_config = {
        ...
        'num_workers': 1,
        'seed': 42,
        'nnetwork': PrivacyClassifierNetworkModule.nnetwork_wine
    }
