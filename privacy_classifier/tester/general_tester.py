...
from pipeline.schema.inputs import PrivacyClassifierInputs
from pipeline.schema.outputs import PrivacyClassifierOutputs
...
from tester.evaluator import PrivacyClassifierEvaluator


##
# @file
# @brief PrivacyClassifierGeneralTester implementation of ZIDS_Tester base class.

class PrivacyClassifierGeneralTester(ZIDS_Tester):
    ...
    def __init__(self):
        ...
        self.pipeline = PrivacyClassifierPipeline()
        ## Instance of the Evaluator class
        self.evaluator = PrivacyClassifierEvaluator()
    ...
    def create_model_request(self, batch_input_rows) -> PrivacyClassifierInputs:
        ...
        model_request = PrivacyClassifierInputs()
...
if __name__ == '__main__':
    ...
    tester = PrivacyClassifierGeneralTester()
    args = sys.argv[1:]
